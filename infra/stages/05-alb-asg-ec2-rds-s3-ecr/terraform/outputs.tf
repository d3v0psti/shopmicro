output "autoscaling_group_name" {
  description = "Nome do Auto Scaling Group do Stage 05."
...
output "ecr_images" {
  description = "Imagens manuais consumidas pelo Stage 05; não são gerenciadas pelo Terraform."
  value = {
...
output "user_data_log_command" {
  ...
  value       = "sudo tail -f /var/log/shopmicro-aws-stage-05.log"
}
